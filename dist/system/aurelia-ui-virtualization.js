System.register(['aurelia-binding', 'aurelia-templating', 'aurelia-templating-resources', 'aurelia-pal', 'aurelia-dependency-injection'], (function (exports) {
    'use strict';
    var mergeSplice, ObserverLocator, ElementEvents, BoundViewFactory, TargetInstruction, ViewSlot, ViewResources, updateOverrideContext, createFullOverrideContext, ArrayRepeatStrategy, NullRepeatStrategy, unwrapExpression, updateOneTimeBinding, viewsRequireLifecycle, getItemsSourceExpression, isOneTime, AbstractRepeater, DOM, PLATFORM, Container;
    return {
        setters: [function (module) {
            mergeSplice = module.mergeSplice;
            ObserverLocator = module.ObserverLocator;
        }, function (module) {
            ElementEvents = module.ElementEvents;
            ...
            updateOverrideContext = module.updateOverrideContext;
            createFullOverrideContext = module.createFullOverrideContext;
            ArrayRepeatStrategy = module.ArrayRepeatStrategy;
            NullRepeatStrategy = module.NullRepeatStrategy;
            unwrapExpression = module.unwrapExpression;
            updateOneTimeBinding = module.updateOneTimeBinding;
            viewsRequireLifecycle = module.viewsRequireLifecycle;
            getItemsSourceExpression = module.getItemsSourceExpression;
            isOneTime = module.isOneTime;
            AbstractRepeater = module.AbstractRepeater;
        }, function (module) {
            DOM = module.DOM;
        ...
        execute: (function () {
            ...
            ***************************************************************************** */
            ...
            var VirtualizationEvents = exports('VirtualizationEvents', Object.assign(Object.create(null), {
            ...
            var VirtualRepeat = exports('VirtualRepeat', (function (_super) {
            ...
            var InfiniteScrollNext = exports('InfiniteScrollNext', (function () {
